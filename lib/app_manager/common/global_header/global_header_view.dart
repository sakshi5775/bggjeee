...
import 'global_header_controller.dart';

class GlobalHeaderView extends GetView<GlobalHeaderController> {
  final String? title;
  final VoidCallback? onMenuTap;

  const GlobalHeaderView({super.key, this.title, this.onMenuTap});
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: () {
                          controller.isHeaderSearchOpen.value = true;
                          controller.headerSearchFocusNode.requestFocus();
                        },
                        style: IconButton.styleFrom(
                          padding: EdgeInsets.zero,
                          minimumSize: Size(36.w, 36.h),
