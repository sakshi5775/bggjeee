...
class _PhoneFieldWithCountryCodeState extends State<PhoneFieldWithCountryCode> {
  ...
  void initState() {
    ...
    _selectedCountry = widget.initialCountry ?? CountryCode.fromCountryCode('IN');
        ...
        SizedBox(
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Container(
                  ...
                  child: CountryCodePicker(
                    key: ValueKey(_selectedCountry?.code ?? 'IN'), // Key to prevent unnecessary rebuilds
                    ...
                    showOnlyCountryWhenClosed: false, // Show flag + country code when closed
              ...
              Expanded(
                child: SizedBox(
                  height: 48.h, // Fixed height - must match country code field
                  child: TextFormField(
                    ...
                    style: MyTextTheme.mediumBCB.copyWith(color: AppColors.textPrimary),
                     decoration: InputDecoration(
                       ...
                       filled: true,
                       fillColor: widget.enabled ? AppColors.white : AppColors.gray.withOpacity(0.1),
                     ),
                    onTapOutside: (val) {
