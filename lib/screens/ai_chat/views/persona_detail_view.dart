...
class PersonaDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Get.put(PersonaDetailController(), tag: personaId, permanent: false);
        ...
        controller.loadPersonaDetail(personaId).then((_) {
          ...
          if (showReviewPrompt && controller.myReview.value == null) {
            Future.delayed(const Duration(milliseconds: 500), () {
              _showReviewDialog(context, controller, personaId, persona: controller.persona.value);
            });
          }
        });
      });
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(() {
          if (controller.isLoading.value && controller.persona.value == null) {
            return const Center(
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              // History icon
              IconButton(
                icon: Icon(Icons.history, color: const Color(0xFF5F2221), size: 20.w),
                onPressed: () {
                  Get.toNamed(AppRoutes.personaVoiceHistory, arguments: {'personaId': persona.id, 'persona': persona});
                },
              ),
              GestureDetector(
                onTap: () {
  ...
  Widget _buildProfileCard(BuildContext context, PersonaModel persona, PersonaDetailController controller) {
    return Container(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.star, color: AppColors.saffron, size: 16.w),
                    SizedBox(width: 4.w),
                    Expanded(
                      child: AutoTranslateText(
                ...
                Row(
                  children: [
                    Icon(Icons.language, color: AppColors.saffron, size: 16.w),
                    SizedBox(width: 4.w),
                    Expanded(
                      child: AutoTranslateText(
                ...
                Row(
                  children: [
                    Icon(Icons.school, color: AppColors.saffron, size: 16.w),
                    SizedBox(width: 4.w),
                    AutoTranslateText(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Icon(Icons.card_giftcard, color: AppColors.saffron, size: 20.w),
            ],
          ),
          Spacing.h(12),
          Obx(() {
            ...
            final shouldShowReadMore = description.isNotEmpty && description.length > 150;
  ...
  Widget _buildRatingsSection(
      BuildContext context, PersonaModel persona, PersonaDetailController controller) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 16.w),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Obx(() {
            if (controller.myReview.value == null) {
              return ElevatedButton.icon(
                onPressed: () => _showReviewDialog(context, controller, persona.id, persona: persona),
  ...
  Widget _buildReviewItem(PersonaReview review, PersonaDetailController controller, String personaId) {
    final userInfo = review.userDisplayInfo;
    // Show maskedPhone instead of displayName
    final displayName = userInfo?.maskedPhone ?? userInfo?.displayName ?? 'Anonymous';
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () => controller.markReviewHelpful(personaId, review.id),
                    child: Row(
                      children: [
                        Icon(
  ...
  void _showReviewDialog(BuildContext context, PersonaDetailController controller, String personaId, {PersonaModel? persona}) {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: () => Get.back(),
                        icon: Icon(Icons.close, color: Colors.grey[600], size: 24.w),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Tell others about your experience with this persona...',
                        ...
                        Expanded(
                          child: OutlinedButton(
                            onPressed: isSubmitting.value
                                ? null
                                : () async {
                                    final success = await controller.deleteReview(
                                      personaId,
                              ...
                              onPressed: isSubmitting.value
                                  ...
                                  : () async {
                                      if (reviewTextController.text.trim().isEmpty) {
                                        errorMessage.value = 'Please share your experience in the review text';
                                        return;
                                      }
  ...
  Widget _buildBottomButtons(BuildContext context, PersonaModel persona, PersonaDetailController controller) {
    return Container(
      padding: EdgeInsets.all(16.w),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Future<void> _handleChatTap(BuildContext context, PersonaModel persona) async {
    final precheckService = ChatCallPrecheckService();
    final canProceed = await precheckService.checkBeforeProceeding(
      persona: persona,
      pricePerMinute: persona.pricePerMin,
