...
class AllAstrologersController extends GetxController {
  ...
  final RxString selectedFilter = 'All'.obs; // All, Vedic, Tarots, Vastu, Prashana, Celebrity, Kids
  final List<String> filterOptions = ['All', 'Vedic', 'Tarots', 'Vastu', 'Prashana', 'Celebrity', 'Kids'];
