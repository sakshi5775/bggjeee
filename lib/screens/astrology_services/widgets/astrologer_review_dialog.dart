...
class AstrologerReviewDialog {
  static void show({
    ...
    final controller = Get.put(AstrologerReviewController(), tag: astrologerId, permanent: false);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      if (astrologer.profilePicture != null && astrologer.profilePicture!.isNotEmpty)
                        ClipOval(
                  ...
                  Obx(() {
                    ...
                    if (onFollow != null && !currentFollowing.value) {
                      return Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: OutlinedButton.icon(
                            onPressed: () {
                              onFollow(); // Safe since we check null in Obx condition
                              // Update follow status after toggle
                              currentFollowing.value = true;
                            },
                            icon: Icon(Icons.person_add, size: 18.w, color: AppColors.saffron),
                            label: Text(
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Tell others about your experience with this astrologer...',
