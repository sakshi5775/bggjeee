...
class _BlogDetailViewState extends State<BlogDetailView> {
  ...
  final RxList<Map<String, dynamic>> _popularTags = <Map<String, dynamic>>[].obs;
    ...
    try {
      ...
      if (response != null && response.data != null) {
        ...
        final related = response.data!
            .where((b) => b.id != widget.blog.id && b.status == 'published' && !(b.isDeleted ?? false))
            .take(3)
            .toList();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          // App Bar with dark reddish-brown background
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Container(
                ...
                child: _isVideoUrl(widget.blog.featuredImage ?? '') &&
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                        ...
                        if (widget.blog.categories != null &&
                          ...
                          Container(
                            ...
                            child: AutoTranslateText(
                              widget.blog.categories!.first.name ?? 'Astrology',
                        ...
                        Row(
                          children: [
                            Icon(Icons.access_time,
                                size: 16.w, color: "#6F221E".toColor()),
                            Spacing.w(6),
                            AutoTranslateText(
                         ...
                         Container(
                           ...
                           child: Row(
                             children: [
                               CircleAvatar(
                                 radius: 24.r,
                                 backgroundColor: "#F38B3B".toColor().withOpacity(0.2),
                                 child: Icon(
                                   Icons.person,
                                   color: '#3E2723'.toColor(),
                                   size: 24.w,
                  ...
                  if (_popularTags.isNotEmpty || (widget.blog.tags != null && widget.blog.tags!.isNotEmpty))
                    Padding(
                      padding: AppPaddings.symmetric(h: 20),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Obx(() => InkWell(
                              onTap: () {
                                ...
                                if (_liked.value) {
                                  ...
                                  _likeCount.value = (_likeCount.value - 1).clamp(0, double.infinity).toInt();
                                }
                              },
                              child: Container(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildCommentItem('Anjali Mehra', '1 day ago', 'Great article!', 3),
                        Spacing.h(12),
                        _buildCommentItem('Rahul Kapoor', '4 days ago', 'Very informative.', 1),
                        Spacing.h(24),
                      ],
                    ),
                  ),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: _buildRelatedArticleCard(relatedBlog),
                              );
                            },
                          )),
                     Spacing.h(24),
  ...
  Widget _buildCommentItem(String name, String time, String comment, int likes) {
    return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Icon(Icons.access_time,
                            size: 12.w, color: "#F38B3B".toColor()),
                        Spacing.w(4),
                        AutoTranslateText(
