...
class CarrotAstrologyResultsView extends StatelessWidget {
          ...
          child: Column(
            children: [
              CommonHeader(
                ...
                actions: [
                  IconButton(
                    icon: Icon(Icons.history,   color: '#DFB343'.toColor(), size: 24.w),
                    onPressed: () => Get.toNamed(AppRoutes.carrotAstrologyHistory),
                  ),
                ],
              ),
              Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (result.zodiacInfo != null) ...[
                            _buildZodiacInfoSection(result.zodiacInfo!, controller),
                            Spacing.h(20),
                          ],
  ...
  Widget _buildZodiacInfoSection(ZodiacInfo zodiacInfo, CarrotAstrologyController controller) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 16.w),
      child: Container(
        padding: EdgeInsets.all(24.w),
        ...
        child: Column(
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (zodiacInfo.rulingPlanet != null || zodiacInfo.element != null) ...[
                        Spacing.h(6),
                        Row(
                          children: [
                            if (zodiacInfo.rulingPlanet != null) ...[
                              Icon(Icons.star, size: 14.w, color: '#DFB343'.toColor()),
                              Spacing.w(4),
                              AutoTranslateText(
                            ...
                            if (zodiacInfo.element != null) ...[
                              Icon(Icons.water_drop, size: 14.w, color: '#DFB343'.toColor()),
                              Spacing.w(4),
                              AutoTranslateText(
                                zodiacInfo.element!,
                                style: MyTextTheme.smallBCN.copyWith(
                ...
                children: zodiacInfo.traits!.map((trait) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: CarrotAstrologyColors.orangeColor.withOpacity(0.4),
                        width: 1.5,
                      ),
                      boxShadow: [
                        BoxShadow(
            ...
            if (zodiacInfo.vegetableEssence != null && zodiacInfo.vegetableEssence!.isNotEmpty) ...[
              Spacing.h(24),
              Row(
                children: [
                  Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (vegetableMatch.name != null && vegetableMatch.name!.isNotEmpty) ...[
              Spacing.h(20),
              Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.local_dining, color: '#DFB343'.toColor(), size: 20.w),
                    Spacing.w(10),
                    Expanded(
                      child: AutoTranslateText(
                        vegetableMatch.name!,
            ...
            if (vegetableMatch.essenceDescription != null && vegetableMatch.essenceDescription!.isNotEmpty) ...[
              Spacing.h(16),
              AutoTranslateText(
            ...
            if (vegetableMatch.symbolism != null && vegetableMatch.symbolism!.isNotEmpty) ...[
              Spacing.h(20),
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.auto_awesome, color: '#DFB343'.toColor(), size: 18.w),
                        Spacing.w(8),
                        AutoTranslateText(
                          'Symbolism',
                          style: MyTextTheme.mediumBCB.copyWith(
      ...
      child: Column(
        ...
        children: [
          ...
          ...items.asMap().entries.map((entry) {
            ...
            return Padding(
              padding: EdgeInsets.only(bottom: index < items.length - 1 ? 14.h : 0),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Colors.white,
              '#FFF2E8'.toColor().withOpacity(0.3),
            ],
          ),
          borderRadius: BorderRadius.circular(20.r),
          border: Border.all(
