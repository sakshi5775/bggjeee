...
import 'package:astrobharataiuser/screens/e_mandir/puja_detail/widgets/puja_detail_header_widget.dart';
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Obx(() {
            ...
            if (controller.errorMessage.value.isNotEmpty && controller.puja.value == null) {
              return Center(
                child: Column(
