...
/// View All page for Popular Remedies – shows all remedy categories with heading "Popular Remedies".
/// Uses its own ScrollController to avoid "attached to multiple scroll views" when same RemediesController is shared.
class PopularRemediesAllView extends StatefulWidget {
  const PopularRemediesAllView({super.key});

  @override
  State<PopularRemediesAllView> createState() => _PopularRemediesAllViewState();
}

class _PopularRemediesAllViewState extends State<PopularRemediesAllView> {
  ...
  Widget _buildCard(RemedyCategoryModel remedy) {
    return Container(
