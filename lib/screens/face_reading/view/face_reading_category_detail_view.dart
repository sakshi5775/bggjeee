      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(icon, color: '#EA632B'.toColor(), size: 32.w),
          ),
          Spacing.w(16),
          Expanded(
            child: Column(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.trending_up, color: '#EA632B'.toColor(), size: 20.w),
              Spacing.w(8),
              AutoTranslateText(
                'Areas For Growth',
                style: MyTextTheme.mediumBCB.copyWith(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.diamond, color: '#EA632B'.toColor(), size: 20.w),
              Spacing.w(8),
              AutoTranslateText(
                'Social Traits',
                style: MyTextTheme.mediumBCB.copyWith(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.lightbulb, color: '#EA632B'.toColor(), size: 20.w),
              Spacing.w(8),
              AutoTranslateText(
                'Recommendations',
                style: MyTextTheme.mediumBCB.copyWith(
