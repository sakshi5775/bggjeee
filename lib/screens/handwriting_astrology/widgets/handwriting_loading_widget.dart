...
class HandwritingLoadingWidget extends StatefulWidget {
  ...
  @override
  State<HandwritingLoadingWidget> createState() => _HandwritingLoadingWidgetState();
}

class _HandwritingLoadingWidgetState extends State<HandwritingLoadingWidget>
                    ...
                    builder: (context, child) {
                      return Transform.rotate(
                        ...
                        child: CustomPaint(
                          ...
                          painter: _HandwritingLoaderPainter(),
                        ),
                      );
                    },
                  ),
              ...
              builder: (context, child) {
                return ShaderMask(
                  ...
                  child: AutoTranslateText(
                    widget.message ?? 'Analyzing Handwriting...',
                    style: TextStyle(
                ...
                return AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    return Container(
                      ...
                      height: 8.w,
                      decoration: BoxDecoration(
                        color: '#FF6B35'.toColor().withOpacity(0.3 + opacity * 0.7),
                        shape: BoxShape.circle,
                      ),
                    );
                  },
...
class _HandwritingLoaderPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    // Draw multiple arcs with different colors
    final arcs = [
      {'color': '#FF6B35', 'start': 0.0, 'sweep': 0.4},
