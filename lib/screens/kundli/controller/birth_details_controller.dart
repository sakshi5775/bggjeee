...
class BirthDetailsController extends BaseController {
  ...
  void _loadData() {
    ...
    if (arguments != null) {
      ...
      if (arguments['planetDetailsData'] != null) {
        planetDetailsData.value =
            arguments['planetDetailsData'] as Map<String, dynamic>?;
      }
    }
  }
  ...
  Future<void> fetchAllData() async {
    await Future.wait([fetchPlanetDetails(), fetchMangalDosh()]);
  }
  ...
  String getDST() {
    ...
    return formData.value!['dst']?.toString() ??
        formData.value!['daylightSaving']?.toString() ??
        '0';
  }
