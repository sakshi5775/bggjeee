...
class AscendantReportWidget extends StatelessWidget {
  ...
  Widget _buildAscendantInfoCard(Map<String, dynamic> data) {
    ...
    final ascendantLordLocation = data['ascendant_lord_location']?.toString() ?? '--';
    final ascendantLordHouseLocation = data['ascendant_lord_house_location']?.toString() ?? '--';
    final ascendantLordStrength = data['ascendant_lord_strength']?.toString() ?? '--';
    final symbol = data['symbol']?.toString() ?? '--';
    final zodiacCharacteristics = data['zodiac_characteristics']?.toString() ?? '--';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDivider(),
          _buildInfoRow('Lord House Location', 'House $ascendantLordHouseLocation'),
          _buildDivider(),
  ...
  Widget _buildPredictionsSection(Map<String, dynamic> data) {
    ...
    final personalisedPrediction = data['personalised_prediction']?.toString() ?? '';
  ...
  Widget _buildPredictionCard(String title, String content, IconData icon, Color color) {
    return Container(
      padding: EdgeInsets.all(20.w),
      decoration: BoxDecoration(
        color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          ...
          if (flagshipQualities.isNotEmpty) ...[
            _buildQualitiesCard('Flagship Qualities', flagshipQualities, Colors.green),
            Spacing.h(16),
          ],
          ...
          if (badQualities.isNotEmpty) ...[
            _buildQualitiesCard('Areas to Improve', badQualities, Colors.orange),
          ],
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          if (spiritualityAdvice.isNotEmpty) ...[
            _buildSpiritualCard('Spirituality Advice', spiritualityAdvice, Icons.lightbulb_outline),
            Spacing.h(16),
          ],
