...
class ChalitChartWidget extends StatelessWidget {
  const ChalitChartWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final svgData = controller.chalitSvgData.value;
