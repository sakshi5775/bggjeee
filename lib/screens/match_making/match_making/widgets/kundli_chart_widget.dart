...
class KundliChartWidget extends StatelessWidget {
  ...
  Map<int, Map<String, double>> _getHousePositions(double size) {
    ...
    return {
      ...
      5: {
        'x':
            center + outerRadius * math.cos(30 * math.pi / 180), // Right-bottom
        'y': center + outerRadius * math.sin(30 * math.pi / 180),
      },
      6: {
        'x':
            center + outerRadius * math.cos(60 * math.pi / 180), // Bottom-right
      ...
      8: {
        'x':
            center + outerRadius * math.cos(120 * math.pi / 180), // Bottom-left
        'y': center + outerRadius * math.sin(120 * math.pi / 180),
      },
      // Inner houses (9-12) - arranged in center area
      9: {
        'x':
            center + innerRadius * math.cos(180 * math.pi / 180), // Left-center
      ...
      12: {
        'x':
            center +
            innerRadius * math.cos(90 * math.pi / 180), // Bottom-center
