...
class NavtaraLoadingWidget extends StatefulWidget {
  final String? message;

  const NavtaraLoadingWidget({Key? key, this.message}) : super(key: key);

  @override
  State<NavtaraLoadingWidget> createState() => _NavtaraLoadingWidgetState();
}

class _NavtaraLoadingWidgetState extends State<NavtaraLoadingWidget>
              ...
              builder: (context, child) {
                return ShaderMask(
                  ...
                  child: AutoTranslateText(
                    widget.message ?? 'Analyzing Navtara...',
                    style: TextStyle(
...
class _NavtaraLoaderPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    // Draw multiple arcs with different colors matching theme
    final arcs = [
