...
class NumerologyResultView extends StatelessWidget {
  ...
  Widget _buildNumberAnalysis(Map<String, dynamic> data) {
    ...
    if (_hasValue(data['nameCompoundNumber'])) {
      coreNumbers.add(
        _buildNumberCard(
          ...
          _getValue(data['nameCompoundNumber']),
    ...
    if (_hasValue(data['westernZodiacSign'])) {
      additionalInfo.add(
        _buildInfoRow('Zodiac Sign', _getValue(data['westernZodiacSign'])),
      );
    }
  ...
  Widget _buildMissingNumbers(Map<String, dynamic> data) {
    ...
    if (_hasValue(data['missingNumbers'])) {
      sections.add(
        _buildSection('Missing Numbers', Icons.remove_circle, [
          _buildNumberInfoCard(
            'Missing Numbers',
            _getValue(data['missingNumbers']),
            AppColors.error,
          ),
        ], AppColors.error),
      );
    ...
    if (data['missingNumberDetails'] != null &&
        data['missingNumberDetails'] is List) {
    ...
    // Remedies
    if (data['missingNumberRemedies'] != null &&
        data['missingNumberRemedies'] is List) {
      ...
      if (remedies.isNotEmpty) {
        sections.add(
          _buildSection('Remedies', Icons.healing, remedies, AppColors.green),
        );
      }
    }
  ...
  Widget _buildAvailableNumbers(Map<String, dynamic> data) {
    ...
    if (_hasValue(data['availableNumbers'])) {
      sections.add(
        _buildSection('Available Numbers', Icons.check_circle, [
          _buildNumberInfoCard(
            'Available Numbers',
            _getValue(data['availableNumbers']),
            AppColors.green,
          ),
        ], AppColors.green),
      );
    ...
    if (data['availableNumberDitails'] != null &&
        data['availableNumberDitails'] is List) {
      final details = <Widget>[];
      for (final item in data['availableNumberDitails'] as List) {
        if (item is Map) {
          ...
          if (number != 'N/A' && description != 'N/A') {
            details.add(
              _buildDescriptionCard(number, description, AppColors.green),
            );
          }
        }
      }
      if (details.isNotEmpty) {
        sections.add(
          _buildSection('Number Details', Icons.info, details, AppColors.green),
        );
      }
    }
  ...
  Widget _buildMobileAnalysis(Map<String, dynamic> data) {
    ...
    if (_hasValue(data['mobileNumber'])) {
      mobileInfo.add(
        _buildInfoRow('Mobile Number', _getValue(data['mobileNumber'])),
      );
    }
    if (_hasValue(data['mobileNumberSum'])) {
      mobileInfo.add(
        _buildInfoRow('Mobile Number Sum', _getValue(data['mobileNumberSum'])),
      );
    }
    if (_hasValue(data['mobileNumberDescriptions'])) {
      mobileInfo.add(
        _buildDescriptionCard(
          ...
          _getValue(data['mobileNumberDescriptions']),
          AppColors.peacockBlue,
        ),
      );
    }
    if (_hasValue(data['negativeNumbers'])) {
      mobileInfo.add(
        _buildInfoRow('Negative Numbers', _getValue(data['negativeNumbers'])),
      );
    }
    if (_hasValue(data['pairsOfThree'])) {
      mobileInfo.add(
        _buildInfoRow('Pairs of Three', _getValue(data['pairsOfThree'])),
      );
    }
    ...
    if (data['individualDigitAnalysis'] != null &&
        data['individualDigitAnalysis'] is List) {
      final digits = <Widget>[];
    ...
    if (data['mobileNumberSumResult'] != null &&
        data['mobileNumberSumResult'] is List) {
      final results = <Widget>[];
      for (final item in data['mobileNumberSumResult'] as List) {
        results.add(
          _buildDescriptionCard('Sum Result', item.toString(), AppColors.green),
        );
      }
  ...
  Widget _buildNumerologySuggestion(Map<String, dynamic> data) {
    ...
    if (data['rudraksha'] != null) {
      ...
      if (_hasValue(rudraksha['zodiac'])) {
        suggestions.add(
          _buildInfoRow('Your Zodiac', _getValue(rudraksha['zodiac'])),
        );
      }
    ...
    if (data['oil'] != null) {
      ...
      if (_hasValue(oil['oil_suggestion'])) {
        ...
        suggestions.add(
          _buildSuggestionCard(
            _getValue(
              oil['oil_suggestion_title'],
              defaultValue: 'Oil Suggestion',
            ),
  ...
  Widget _buildNameAnalysis(Map<String, dynamic> data) {
    ...
    if (_hasValue(data['nameCompatibilityAsPerMoolank'])) {
      compatibility.add(
        _buildInfoRow(
          'Compatibility (Moolank)',
          _getValue(data['nameCompatibilityAsPerMoolank']),
        ),
      );
    }
    if (_hasValue(data['nameCompatibilityAsPerBhagyank'])) {
      compatibility.add(
        _buildInfoRow(
          'Compatibility (Bhagyank)',
          _getValue(data['nameCompatibilityAsPerBhagyank']),
        ),
      );
    }
    if (_hasValue(data['overallNameCompatibilityAsPerMoolankBhagyank'])) {
      compatibility.add(
        _buildDescriptionCard(
          ...
          _getValue(data['overallNameCompatibilityAsPerMoolankBhagyank']),
          AppColors.templeGold,
        ),
      );
    }
    if (_hasValue(data['firstNameCompatibilityAsPerMoolank'])) {
      compatibility.add(
        _buildInfoRow(
          'First Name (Moolank)',
          _getValue(data['firstNameCompatibilityAsPerMoolank']),
        ),
      );
    }
    if (_hasValue(data['firstNameCompatibilityAsPerBhagyank'])) {
      compatibility.add(
        _buildInfoRow(
          'First Name (Bhagyank)',
          _getValue(data['firstNameCompatibilityAsPerBhagyank']),
        ),
      );
    }
    if (_hasValue(data['overallFirstNameCompatibilityAsPerMoolankBhagyank'])) {
      compatibility.add(
        _buildDescriptionCard(
          'First Name Overall',
          _getValue(data['overallFirstNameCompatibilityAsPerMoolankBhagyank']),
          AppColors.templeGold,
        ),
      );
    }
    ...
    if (_hasValue(data['suggestedNameNumber'])) {
      suggestedNumbers.add(
        _buildNumberInfoCard(
          ...
          _getValue(data['suggestedNameNumber']),
          AppColors.saffron,
        ),
      );
    }
    ...
    if (data['suggestedNameSpellings'] != null &&
        data['suggestedNameSpellings'] is List) {
  ...
  Widget _buildVehicleAnalysis(Map<String, dynamic> data) {
    ...
    if (_hasValue(data['vehicleNumber'])) {
      vehicleInfo.add(
        _buildInfoRow('Vehicle Number', _getValue(data['vehicleNumber'])),
      );
    }
    if (_hasValue(data['vehicleNumberSum'])) {
      vehicleInfo.add(
        _buildInfoRow(
          'Vehicle Number Sum',
          _getValue(data['vehicleNumberSum']),
        ),
      );
    }
    if (_hasValue(data['vehicleNumberDescriptions'])) {
      vehicleInfo.add(
        _buildDescriptionCard(
          ...
          _getValue(data['vehicleNumberDescriptions']),
          AppColors.peacockBlue,
        ),
      );
    }
    ...
    if (data['vehicleNumberSumResult'] != null &&
        data['vehicleNumberSumResult'] is List) {
      final results = <Widget>[];
  ...
  Widget _buildLuckyThings(Map<String, dynamic> data) {
    ...
    if (lt['numbers'] != null) {
      ...
      if (numbers['lucky'] != null && _hasValue(numbers['lucky']['value'])) {
        numberCards.add(
          _buildLuckyCard(
            'Lucky Numbers',
            _getValue(numbers['lucky']['value']),
            AppColors.green,
          ),
        );
      }
      if (numbers['unlucky'] != null &&
          _hasValue(numbers['unlucky']['value'])) {
        numberCards.add(
          _buildLuckyCard(
            'Unlucky Numbers',
            _getValue(numbers['unlucky']['value']),
            AppColors.error,
          ),
        );
      }
      if (numbers['neutral'] != null &&
          _hasValue(numbers['neutral']['value'])) {
        numberCards.add(
          _buildLuckyCard(
            'Neutral Numbers',
            _getValue(numbers['neutral']['value']),
            AppColors.gray,
          ),
        );
      }
    ...
    if (lt['dates_days'] != null) {
      ...
      if (datesDays['lucky_dates'] != null &&
          _hasValue(datesDays['lucky_dates']['value'])) {
        dateCards.add(
          _buildLuckyCard(
            'Lucky Dates',
            _getValue(datesDays['lucky_dates']['value']),
            AppColors.templeGold,
          ),
        );
      }
      if (datesDays['lucky_days'] != null &&
          _hasValue(datesDays['lucky_days']['value'])) {
        dateCards.add(
          _buildLuckyCard(
            'Lucky Days',
            _getValue(datesDays['lucky_days']['value']),
            AppColors.deepOrange,
          ),
        );
      }
    ...
    if (lt['colors_directions'] != null) {
      ...
      if (colorsDirs['colors'] != null &&
          _hasValue(colorsDirs['colors']['value'])) {
        colorCards.add(
          _buildLuckyCard(
            'Lucky Colors',
            _getValue(colorsDirs['colors']['value']),
            AppColors.peacockBlue,
          ),
        );
      }
      if (colorsDirs['lucky_direction'] != null &&
          _hasValue(colorsDirs['lucky_direction']['value'])) {
        colorCards.add(
          _buildLuckyCard(
            'Lucky Direction',
            _getValue(colorsDirs['lucky_direction']['value']),
            AppColors.spiritualPurple,
          ),
        );
      }
      if (colorsDirs['main_gate_direction'] != null &&
          _hasValue(colorsDirs['main_gate_direction']['value'])) {
        colorCards.add(
          _buildLuckyCard(
            'Main Gate Direction',
            _getValue(colorsDirs['main_gate_direction']['value']),
            AppColors.turmericYellow,
          ),
        );
      }
    ...
    if (_hasValue(lt['best_time_of_the_day'])) {
      otherInfo.add(
        _buildInfoRow(
          'Best Time of Day',
          _getValue(lt['best_time_of_the_day']),
        ),
      );
    }
    if (lt['traits'] != null &&
        lt['traits'] is List &&
        (lt['traits'] as List).isNotEmpty) {
      otherInfo.add(
        _buildDescriptionCard(
          'Traits',
          (lt['traits'] as List).join(', '),
          AppColors.peacockBlue,
        ),
      );
    }
    if (lt['favourable_periods'] != null &&
        lt['favourable_periods'] is List &&
        (lt['favourable_periods'] as List).isNotEmpty) {
      otherInfo.add(
        _buildDescriptionCard(
          'Favourable Periods',
          (lt['favourable_periods'] as List).join(', '),
          AppColors.green,
        ),
      );
    }
  ...
  Widget _buildPersonalYear(Map<String, dynamic> data) {
    ...
    if (_hasValue(data['personalYear'])) {
      sections.add(
        _buildSection('Personal Year', Icons.calendar_today, [
          _buildInsightCard(
            'Your Personal Year',
            _getValue(data['personalYear']),
            AppColors.templeGold,
          ),
        ], AppColors.templeGold),
      );
    ...
    if (data['description'] != null) {
      ...
      if (_hasValue(desc['title'])) {
        descriptionCards.add(
          _buildInsightCard(
            'Year Theme',
            _getValue(desc['title']),
            AppColors.deepOrange,
          ),
        );
      }
    ...
    if (data['luckFactorDetails'] != null) {
      ...
      if (_hasValue(luck['title'])) {
        luckCards.add(
          _buildInsightCard(
            'Luck Factor',
            _getValue(luck['title']),
            AppColors.templeGold,
          ),
        );
      }
      if (luck['descriptions'] != null &&
          luck['descriptions'] is List &&
          (luck['descriptions'] as List).isNotEmpty) {
        final luckDesc = (luck['descriptions'] as List).join('\n');
        luckCards.add(
          _buildDescriptionCard('Luck Details', luckDesc, AppColors.templeGold),
        );
      }
  ...
  Widget _buildKarmicNumber(Map<String, dynamic> data) {
    ...
    if (_hasValue(data['karmicNumbers'])) {
      sections.add(
        _buildSection('Karmic Numbers', Icons.auto_awesome, [
          _buildNumberInfoCard(
            'Karmic Numbers',
  ...
  Widget _buildMasterNumbers(Map<String, dynamic> data) {
    ...
    if (data['master_conductor'] != null) {
      ...
      if (_hasValue(mc['message'])) {
        sections.add(
          _buildSection('Master Conductor', Icons.auto_awesome, [
            _buildDescriptionCard(
              'Master Conductor',
              _getValue(mc['message']),
              AppColors.deepOrange,
            ),
          ], AppColors.deepOrange),
        );
  ...
  Widget _buildKeyPoints(Map<String, dynamic> data) {
    ...
    final numberAnalysis = data['radicalNumber'] != null
        ? data
        : (data['numberAnalysisData'] as Map<String, dynamic>? ?? {});
    final numerologySuggestion =
        data['numerologySuggestionData'] as Map<String, dynamic>? ?? {};
    final nameAnalysis =
        data['nameAnalysisData'] as Map<String, dynamic>? ?? {};
    final luckyThings = data['luckyThingsData'] as Map<String, dynamic>? ?? {};
    final missingNumbers =
        data['missingNumbersData'] as Map<String, dynamic>? ?? {};
    final availableNumbers =
        data['availableNumbersData'] as Map<String, dynamic>? ?? {};
    final mobileAnalysis =
        data['mobileAnalysisData'] as Map<String, dynamic>? ?? {};
    final personalYear =
        data['personalYearData'] as Map<String, dynamic>? ?? {};
    final karmicNumber =
        data['karmicNumberData'] as Map<String, dynamic>? ?? {};
    final masterNumbers =
        data['masterNumbersData'] as Map<String, dynamic>? ?? {};
    ...
    if (formData != null) {
      ...
      if (hasValue(formData['date'])) {
        basicInfo.add(
          _buildInfoRow('Date of Birth', getValue(formData['date'])),
        );
      }
    ...
    if (hasValue(numberAnalysis['radicalNumber'])) {
      coreNumbers.add(
        _buildNumberCard(
          'Radical Number',
          getValue(numberAnalysis['radicalNumber']),
          AppColors.saffron,
        ),
      );
    }
    if (hasValue(numberAnalysis['destinyNumber'])) {
      coreNumbers.add(
        _buildNumberCard(
          'Destiny Number',
          getValue(numberAnalysis['destinyNumber']),
          AppColors.deepOrange,
        ),
      );
    }
    if (hasValue(numberAnalysis['nameNumber'])) {
      coreNumbers.add(
        _buildNumberCard(
          'Name Number',
          getValue(numberAnalysis['nameNumber']),
          AppColors.templeGold,
        ),
      );
    }
    ...
    if (hasValue(numberAnalysis['westernZodiacSign'])) {
      coreNumbers.add(
        _buildZodiacCard(
          'Zodiac Sign',
          getValue(numberAnalysis['westernZodiacSign']),
          AppColors.sacredRed,
        ),
      );
    }
    ...
    if (numerologySuggestion.isNotEmpty) {
      ...
      if (numerologySuggestion['rudraksha'] != null) {
        final rudraksha =
            numerologySuggestion['rudraksha'] as Map<String, dynamic>;
    ...
    if (luckyThings.isNotEmpty && luckyThings['luckyThings'] != null) {
      ...
      if (lt['numbers'] != null) {
        ...
        if (numbers['lucky'] != null && hasValue(numbers['lucky']['value'])) {
          luckyItems.add(
            _buildLuckyCard(
              'Lucky Numbers',
              getValue(numbers['lucky']['value']),
              AppColors.green,
            ),
          );
        }
        if (numbers['unlucky'] != null &&
            hasValue(numbers['unlucky']['value'])) {
          luckyItems.add(
            _buildLuckyCard(
              'Unlucky Numbers',
              getValue(numbers['unlucky']['value']),
              AppColors.error,
            ),
          );
        }
        if (numbers['neutral'] != null &&
            hasValue(numbers['neutral']['value'])) {
          luckyItems.add(
            _buildLuckyCard(
              'Neutral Numbers',
              getValue(numbers['neutral']['value']),
              AppColors.gray,
            ),
          );
        }
      ...
      if (lt['dates_days'] != null) {
        final datesDays = lt['dates_days'] as Map<String, dynamic>;
        if (datesDays['lucky_dates'] != null &&
            hasValue(datesDays['lucky_dates']['value'])) {
          luckyItems.add(
            _buildLuckyCard(
              'Lucky Dates',
              getValue(datesDays['lucky_dates']['value']),
              AppColors.templeGold,
            ),
          );
        }
        if (datesDays['lucky_days'] != null &&
            hasValue(datesDays['lucky_days']['value'])) {
          luckyItems.add(
            _buildLuckyCard(
              'Lucky Days',
              getValue(datesDays['lucky_days']['value']),
              AppColors.deepOrange,
            ),
          );
        }
      ...
      if (lt['colors_directions'] != null) {
        final colorsDirs = lt['colors_directions'] as Map<String, dynamic>;
        if (colorsDirs['colors'] != null &&
            hasValue(colorsDirs['colors']['value'])) {
          luckyItems.add(
            _buildLuckyCard(
              'Lucky Colors',
              getValue(colorsDirs['colors']['value']),
              AppColors.peacockBlue,
            ),
          );
        }
        if (colorsDirs['lucky_direction'] != null &&
            hasValue(colorsDirs['lucky_direction']['value'])) {
          luckyItems.add(
            _buildLuckyCard(
              'Lucky Direction',
              getValue(colorsDirs['lucky_direction']['value']),
              AppColors.spiritualPurple,
            ),
          );
        }
        if (colorsDirs['main_gate_direction'] != null &&
            hasValue(colorsDirs['main_gate_direction']['value'])) {
          luckyItems.add(
            _buildLuckyCard(
              'Main Gate Direction',
              getValue(colorsDirs['main_gate_direction']['value']),
              AppColors.turmericYellow,
            ),
          );
        }
      ...
      if (hasValue(lt['best_time_of_the_day'])) {
        luckyItems.add(
          _buildLuckyCard(
            'Best Time of Day',
            getValue(lt['best_time_of_the_day']),
            AppColors.sacredRed,
          ),
        );
      }
      ...
      if (lt['traits'] != null &&
        ...
        luckyItems.add(
          _buildLuckyCard('Traits', traits, AppColors.peacockBlue),
        );
      }
      ...
      if (lt['favourable_periods'] != null &&
        ...
        luckyItems.add(
          _buildLuckyCard('Favourable Periods', periods, AppColors.green),
        );
      }
    ...
    if (missingNumbers.isNotEmpty &&
        hasValue(missingNumbers['missingNumbers'])) {
      numbersAnalysis.add(
        _buildNumberInfoCard(
          'Missing Numbers',
          getValue(missingNumbers['missingNumbers']),
          AppColors.error,
        ),
      );
    }
    if (availableNumbers.isNotEmpty &&
        hasValue(availableNumbers['availableNumbers'])) {
      numbersAnalysis.add(
        _buildNumberInfoCard(
          'Available Numbers',
          getValue(availableNumbers['availableNumbers']),
          AppColors.green,
        ),
      );
    }
    if (nameAnalysis.isNotEmpty) {
      if (hasValue(nameAnalysis['luckyNumbers'])) {
        numbersAnalysis.add(
          _buildNumberInfoCard(
            'Lucky Numbers',
            getValue(nameAnalysis['luckyNumbers']),
            AppColors.green,
          ),
        );
      }
      if (hasValue(nameAnalysis['neutralNumbers'])) {
        numbersAnalysis.add(
          _buildNumberInfoCard(
            'Neutral Numbers',
            getValue(nameAnalysis['neutralNumbers']),
            AppColors.gray,
          ),
        );
      }
      if (hasValue(nameAnalysis['unluckyNumbers'])) {
        numbersAnalysis.add(
          _buildNumberInfoCard(
            'Unlucky Numbers',
            getValue(nameAnalysis['unluckyNumbers']),
            AppColors.error,
          ),
        );
      }
    ...
    if (personalYear.isNotEmpty) {
      if (hasValue(personalYear['personalYear'])) {
        insights.add(
          _buildInsightCard(
            'Personal Year',
            getValue(personalYear['personalYear']),
            AppColors.templeGold,
          ),
        );
      }
    ...
    if (mobileAnalysis.isNotEmpty) {
      ...
      if (hasValue(mobileAnalysis['mobileNumber'])) {
        mobileItems.add(
          _buildInfoRow(
            'Mobile Number',
            getValue(mobileAnalysis['mobileNumber']),
          ),
        );
      }
      if (hasValue(mobileAnalysis['mobileNumberSum'])) {
        mobileItems.add(
          _buildInfoRow(
            'Mobile Number Sum',
            getValue(mobileAnalysis['mobileNumberSum']),
          ),
        );
      }
      if (hasValue(mobileAnalysis['mobileNumberDescriptions'])) {
        mobileItems.add(
          _buildDescriptionCard(
            'Mobile Number Analysis',
            getValue(mobileAnalysis['mobileNumberDescriptions']),
            AppColors.peacockBlue,
          ),
        );
      }
      if (hasValue(mobileAnalysis['negativeNumbers'])) {
        mobileItems.add(
          _buildInfoRow(
            'Negative Numbers',
            getValue(mobileAnalysis['negativeNumbers']),
          ),
        );
      }
      if (hasValue(mobileAnalysis['pairsOfThree'])) {
        mobileItems.add(
          _buildInfoRow(
            'Pairs of Three',
            getValue(mobileAnalysis['pairsOfThree']),
          ),
        );
      }
    ...
    if (nameAnalysis.isNotEmpty) {
      ...
      if (hasValue(nameAnalysis['nameCompatibilityAsPerMoolank'])) {
        compatibility.add(
          _buildInfoRow(
            'Compatibility (Moolank)',
            getValue(nameAnalysis['nameCompatibilityAsPerMoolank']),
          ),
        );
      }
      if (hasValue(nameAnalysis['nameCompatibilityAsPerBhagyank'])) {
        compatibility.add(
          _buildInfoRow(
            'Compatibility (Bhagyank)',
            getValue(nameAnalysis['nameCompatibilityAsPerBhagyank']),
          ),
        );
      }
      if (hasValue(
        nameAnalysis['overallNameCompatibilityAsPerMoolankBhagyank'],
      )) {
        compatibility.add(
          _buildDescriptionCard(
            'Overall Compatibility',
      ...
      if (hasValue(nameAnalysis['firstNameCompatibilityAsPerMoolank'])) {
        compatibility.add(
          _buildInfoRow(
            'First Name (Moolank)',
            getValue(nameAnalysis['firstNameCompatibilityAsPerMoolank']),
          ),
        );
      }
      if (hasValue(nameAnalysis['firstNameCompatibilityAsPerBhagyank'])) {
        compatibility.add(
          _buildInfoRow(
            'First Name (Bhagyank)',
            getValue(nameAnalysis['firstNameCompatibilityAsPerBhagyank']),
          ),
        );
      }
      if (hasValue(
        nameAnalysis['overallFirstNameCompatibilityAsPerMoolankBhagyank'],
      )) {
        compatibility.add(
          _buildDescriptionCard(
            'First Name Overall',
      ...
      return Center(
        child: Padding(
          ...
          child: AutoTranslateText(
            ...
            style: MyTextTheme.mediumBCN.copyWith(color: AppColors.textPrimary),
          ),
        ),
      );
    }
          ...
          Row(
            children: [
              Container(
                ...
                child: Center(
                  child: Icon(Icons.star, color: color, size: 24.w),
                ),
              ),
              Spacing.w(16),
              Expanded(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.star, color: AppColors.white, size: 20.w),
          ),
          Spacing.w(12),
          Expanded(
            child: Column(
  ...
  List<Widget> _buildAllFields(
    ...
    for (final entry in data.entries) {
      ...
      if (entry.value is Map) {
        widgets.add(_buildSectionTitle(_formatFieldName(entry.key)));
        widgets.add(Spacing.h(12));
        widgets.addAll(
          _buildAllFields(entry.value as Map<String, dynamic>, prefix: key),
        );
        ...
        for (int i = 0; i < list.length; i++) {
          ...
          if (item is Map) {
            widgets.addAll(
              _buildAllFields(item as Map<String, dynamic>, prefix: '$key[$i]'),
            );
          } else {
        ...
        widgets.add(
          _buildInfoCard(_formatFieldName(entry.key), entry.value.toString()),
        );
        widgets.add(Spacing.h(12));
      }
    }
  ...
  Widget _buildSectionTitle(String title) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.category, color: AppColors.white, size: 20.w),
          Spacing.w(10),
          AutoTranslateText(
            title,
            style: MyTextTheme.largeBCB.copyWith(
            ...
            widgets.add(
              Column(
                ...
                children: [
                  ...
                  Spacing.h(12),
                  ...value
                      .map((v) => _buildInfoCard('', v.toString()))
                      .toList(),
                ],
              ),
            );
