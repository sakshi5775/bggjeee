...
class BhadraController extends BaseController {
  ...
  final monthlyBhadrakaal = <Map<String, dynamic>>[].obs;
  ...
  /// Fetch daily panchang (for today's bhadrakaal) and monthly panchang (all days)
  Future<void> fetchBhadrakaalData() async {
    ...
    try {
      ...
      if (results[1] != null) {
        ...
        monthlyBhadrakaal.assignAll(list.cast<Map<String, dynamic>>());
      } else {
        monthlyBhadrakaal.clear();
      }
    } catch (e) {
