...
class YearlyVratController extends BaseController {
  ...
  /// Fetch yearly vrat data for selected month only
  Future<void> fetchYearlyVrat() async {
    try {
      isLoading.value = true;
      final vratData = <Map<String, dynamic>>[];
