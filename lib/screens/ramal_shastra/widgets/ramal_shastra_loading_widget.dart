...
class RamalShastraLoadingWidget extends StatefulWidget {
  final String? message;
  
  const RamalShastraLoadingWidget({
    Key? key,
    this.message,
  }) : super(key: key);

  @override
  State<RamalShastraLoadingWidget> createState() => _RamalShastraLoadingWidgetState();
}

class _RamalShastraLoadingWidgetState extends State<RamalShastraLoadingWidget>
    ...
    return Dialog(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // Animated loader with dice icon
            SizedBox(
              width: 120.w,
              height: 120.w,
              child: Stack(
              ...
              builder: (context, child) {
                return ShaderMask(
                  ...
                  child: AutoTranslateText(
                    widget.message ?? 'Ramal Shastra is analyzing your question...',
                    style: TextStyle(
...
class _RamalLoaderPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    // Draw multiple arcs with different colors matching Ramal theme
    final arcs = [
