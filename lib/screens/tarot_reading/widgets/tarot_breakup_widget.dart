...
class TarotBreakupWidget extends StatelessWidget {
  ...
  const TarotBreakupWidget({
    super.key,
    this.isRomantic = true,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      debugPrint('🔍 Breakup Widget (${isRomantic ? "romantic" : "business"}) - isLoading: $isLoading, response: ${response != null ? "exists" : "null"}, readingType: ${controller.selectedReadingType.value}');
      if (response != null) {
        debugPrint('🔍 Breakup Response - cause: ${response.cause.name}, advise: ${response.advise.name}');
      }
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    AutoTranslateText(
                                      isRomantic ? 'Romantic Breakup' : 'Business Breakup',
