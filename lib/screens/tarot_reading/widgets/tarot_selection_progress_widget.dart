  ...
  Widget _buildBreakupProgress(TarotController controller) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16.r),
        border: Border.all(
          color: (isRomantic ? Colors.red : "#F38B3B".toColor()).withValues(alpha: 0.3),
          width: 2,
        ),
        boxShadow: [
          BoxShadow(
            color: (isRomantic ? Colors.red : "#F38B3B".toColor()).withValues(alpha: 0.2),
            blurRadius: 8,
            offset: const Offset(0, 4),
          ),
        ],
        ...
        children: [
          Row(
            children: [
              Icon(
                ...
                color: isRomantic ? Colors.red : "#F38B3B".toColor(),
                size: 24.w,
              ),
              Spacing.w(8),
              AutoTranslateText(
          ...
          Center(
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: (isRomantic ? Colors.red : AppColors.orangeGradient.colors.first).withValues(alpha: 0.1),
                padding: EdgeInsets.symmetric(horizontal: 24.w, vertical: 8.h),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(8.r),
                  side: BorderSide(
        ...
        children: [
          ...
          Center(
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: AppColors.orangeGradient.colors.first.withValues(alpha: 0.1),
                padding: EdgeInsets.symmetric(horizontal: 24.w, vertical: 8.h),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(8.r),
  ...
  Widget _buildDirectionButton({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? "#F38B3B".toColor() : Colors.white,
          borderRadius: BorderRadius.circular(12.r),
          border: Border.all(
            color: isSelected
                ? "#F38B3B".toColor()
        ...
        child: Column(
          children: [
            Icon(
              icon,
              color: isSelected ? Colors.white : "#F38B3B".toColor(),
              size: 32.w,
            ),
            Spacing.h(8),
            AutoTranslateText(
