              ...
              _buildDrawerSection(
                ...
                children: [
                  ...
                  _buildDrawerItemStatic(
                    ...
                    onTap: () {
                      Navigator.of(context).pop();
                      Get.toNamed(AppRoutes.allAstrologers, arguments: 'Tarots');
                    },
                  ),
                  _buildDrawerItemStatic(
                    context: context,
                  ...
                  _buildDrawerItemStatic(
                    ...
                    onTap: () {
                      Navigator.of(context).pop();
                      Get.toNamed(AppRoutes.allAstrologers, arguments: 'Prashana');
                    },
                  ),
                  _buildDrawerItemStatic(
                    context: context,
                    ...
                    onTap: () {
                      Navigator.of(context).pop();
                      Get.toNamed(AppRoutes.allAstrologers, arguments: 'Celebrity');
                    },
                  ),
                  _buildDrawerItemStatic(
                    context: context,
