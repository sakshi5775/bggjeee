...
class VastuReadingController extends GetxController {
  ...
  static const Duration _throttleDuration = Duration(milliseconds: 100); // Increased for better performance
  ...
  void _initializeCompass() {
    ...
    _magnetometerSubscription = magnetometerEventStream(
      samplingPeriod: SensorInterval.normalInterval, // Slower than uiInterval
    ).listen(
  ...
  void resumeSensors() {
    ...
    if (_magnetometerSubscription == null || _accelerometerSubscription == null) {
      _initializeCompass();
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                AutoTranslateText(
                  ...
                  style: MyTextTheme.mediumBCN.copyWith(fontSize: 14.sp).merge(AppTypography.body1),
                ),
                SizedBox(height: 16.h),
                ...
                if (roomConfig.remedies.isNotEmpty) ...[
                  ...
                  SizedBox(height: 8.h),
                  ...roomConfig.remedies.map((remedy) => Padding(
                    padding: EdgeInsets.only(left: 16.w, bottom: 4.h),
                    child: AutoTranslateText(
                      '• $remedy',
                      style: MyTextTheme.smallBCN.copyWith(fontSize: 14.sp).merge(AppTypography.body1),
                    ),
                  )),
                ],
                SizedBox(height: 16.h),
