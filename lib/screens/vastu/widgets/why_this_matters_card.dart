...
class _WhyThisMattersCardState extends State<WhyThisMattersCard>
  ...
  Widget build(BuildContext context) {
    ...
    if (isIdeal) {
      explanation =
          'This direction is ideal for ${widget.roomConfig.displayName} because it aligns with the natural energy flow. Following Vastu principles in this direction brings harmony, prosperity, and positive energy to your space.';
    } else if (isAvoid) {
      explanation =
          'This direction should be avoided for ${widget.roomConfig.displayName} as it conflicts with Vastu principles. Placing this room here may cause negative energy, health issues, or financial problems. Consider remedies or relocation.';
    } else {
      explanation =
          'This direction is neutral for ${widget.roomConfig.displayName}. While not ideal, it can work with proper Vastu remedies and adjustments. Consider implementing suggested remedies for better results.';
    }
