class AppConstant {
  ...
  static const String quoteOfTheDay = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/quote_of_the_day.png';
  
  // Onboarding Screen Backgrounds
  static const String onboardingScreen1Bgimg = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Onboarding+Screens/onboarding_screen1_bgimg.png';
  static const String onboardingScreen2Bgimg = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Onboarding+Screens/onboarding_screen2_bgimg.png';
  static const String onboardingScreen3Bgimg = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Onboarding+Screens/onboarding_screen3_bgimg.png';
  
  // Match Making JSON Files
  static const String matchMakingKundliJson = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Json/match_making_kundli.json';
  static const String matchMakingAnimationJson = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Json/match_making_animation.json';
  
  // Kundli Images
  static const String kundliBoy = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/kundliBoy.png';
  static const String kundliGirl = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/kundliGirl.png';
  
  // Book Images
  static const String book = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/book.png';
  static const String bookBackground = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/book_background.png';
  
  // Vastu Compass Images
  static const String needle = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/needle.png';
  static const String outerFrame = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/outer_frame.png';
  static const String star = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/star.png';
  static const String zoneRing = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/zone_ring.png';
  static const String directionRing = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/direction_ring.png';
  
  // Face Reading Images
  static const String faceReadingEx = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Face+Reading/face_reading_ex.png';
  static const String faceReadingEx2 = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Face+Reading/face_reading_ex_2.png';
  static const String faceReadingEx3 = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Face+Reading/face_reading_ex_3.png';
  static const String faceReadingHub = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/FaceReadingHub.png';
  
  // Palm Reading Images
  static const String palmreadingscreen = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/palmreadingscreen.png';
  static const String palmscan = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/palmscan.png';
  
  // Free Service Image
  static const String freeservice = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/freeservice.png';
  
  // Audio Files
  static const String aartiMp3 = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Audio/aarti.mp3';
  static const String shankhMp3 = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Audio/shankh.mp3';
  ...
  static const String aiAstrologer = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/AIAstrologer.svg';
  ...
  // ecommerce images
  static const String shopMainBanner = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Images/shop_main_banner.png';
  ...
  static const String servicePanchang = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/Panchang.svg';
  static const String serviceMatchMaking =
      'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/KundliMatching.svg';
  static const String serviceNumerology = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/numerology.svg';
  static const String serviceTarot = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/TarrotCard.svg';
  static const String serviceRasiChart = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/RasiChart.svg';

  // Common
  static const String fullChakra = 'assets/app/fullchakra.svg';

  // Dashboard card images
  static const String cardConsultation = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/App/ganeshji_u.png';
  static const String cardPalm = 'assets/app/palmReadingCard.png';
  static const String cardKundli = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/Kundli.png';

  static const String tarot = 'assets/app/tarot.svg';

  static const String horoscope = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/Horoscope.svg';
  static const String vastu = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/Vastu.png';
  static const String writingAstrology = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/Writing.svg';
  static const String ramalShastra = 'assets/app/ramalShastra.png';
  static const String carrotAstrology = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/carrotAstrology.png';
  ...
  // shop banner images
  static const String shopBanner1 = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Images/BANNER+1.png';
  static const String shopBanner2 = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Images/BANNER+2.png';
  static const String shopBanner3 = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Images/BANNER+3.png';
  static const String shopBanner4 = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Images/BANNER+4.png';
  static const String shopBanner5 = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/AstroBharatAI+User+App/Images/BANNER+5.png';
  ...
  static const String lifePredictions = 'assets/app/predictions.png';

  static const String dosh = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/Dosh.svg';

  static const String dasha = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/Dasha.png';

  static const String kPAstrology = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/KPAstrology.svg';

  static const String lalKitab = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Astro+Service/LalKitab.svg';
  ...
  // Zodiac Sign Images
  static const String zodiacAries = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Zodiac+Signs/aries.png';
  static const String zodiacTaurus = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Zodiac+Signs/taurus.png';
  static const String zodiacGemini = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Zodiac+Signs/gemini.png';
  static const String zodiacCancer = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Zodiac+Signs/cancerpng.png';
  static const String zodiacLeo = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Zodiac+Signs/leo.png';
  static const String zodiacVirgo = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Zodiac+Signs/virgo.png';
  static const String zodiacLibra = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Zodiac+Signs/libra.png';
  static const String zodiacScorpio = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Zodiac+Signs/scorpio.png';
  static const String zodiacSagittarius =
      'https://astrobharatai.s3.ap-south-1.amazonaws.com/Zodiac+Signs/sagitarius.png';
  static const String zodiacCapricorn =
      'https://astrobharatai.s3.ap-south-1.amazonaws.com/Zodiac+Signs/capricorn.png';
  static const String zodiacAquarius = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Zodiac+Signs/aquarius.png';
  static const String zodiacPisces = 'https://astrobharatai.s3.ap-south-1.amazonaws.com/Zodiac+Signs/pisces.png';
